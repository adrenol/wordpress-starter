...
class YooKassaGateway extends WC_Payment_Gateway
{
    ...
    const CMS_NAME = 'yoo_woocommerce_epl';
    const CMS_NAME_OLD = 'yoo_woocommerce';

    public $pluginKey = 'yookassa';
    ...
    {
        echo '<h5>'.__(
                'Для работы с модулем необходимо <a href="https://yoomoney.ru/joinups/">подключить магазин к ЮKassa</a>.',
                'yookassa'
            ).'</h5>';
