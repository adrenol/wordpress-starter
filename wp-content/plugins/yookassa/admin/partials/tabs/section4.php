    ...
    <div class="col-md-12">
        ...
        <div class="row padding-bottom">
            <div class="col-md-12 form-group">
                ...
                <p class="help-block text-muted qa-enable-receipt-control-info">
                    <?= __('Автоотправка доступна только ИП и юрлицам. Самозанятым нужно формировать чеки вручную — через сервис «Мой налог»', 'yookassa');?>
                </p>
            </div>
        </div>
        ...
        <div id="tax-collapsible" class="in collapse<?=($isReceiptEnabled) ? ' show' : ''; ?>">
            ...
            <div class="content yookassa_legal_entity in collapse show">
                <div class="row">
                    <div class="col-md-12">
